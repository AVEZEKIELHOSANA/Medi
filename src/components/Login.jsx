...
<h2 className='text-2xl text-gray-800 py-5 font-bold text-center'>Welcomee! back to MediFinder</h2>
<p  className='text-xl text-gray-800 py-5 font-bold text-center'>We are glad to have you back!</p>
